...
<v-layout>
      <v-flex xs12 sm6 offset-sm3>
        <v-card>
          ...
          <v-card-text>
          <div>
          <p><strong><u>Comment nous transmettre vos maquettes ?</u></strong><br>
          Kofton Music met à votre disposition une adresse dédiée :<br>
          <a href="mailto:contact@kofton-music.com">contact@kofton-music.com</a><br>
          </p>
